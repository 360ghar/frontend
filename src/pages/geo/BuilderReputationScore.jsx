...
export default function BuilderReputationScore() {
  ...
  return (
    <>
      <SEO
        title={`Builder Reputation Score Gurugram 2026 | RERA & Complaint Data | 360Ghar`}
        description={`Check reputation scores for all major builders in Gurugram. Ranked by HRERA compliance, complaints, and delivery history. Updated 2026 data by 360Ghar.`}
        keywords={`builder reputation score Gurugram, reliable builders Gurgaon 2026, RERA score builders Gurugram, HRERA complaint history, best developers Gurugram, DLF reputation, M3M reputation score`}
        canonical="/builder-reputation-score"
        structuredData={[
          ...datasetNodes,
          ...
          generateBreadcrumbStructuredData([
            ...
            { name: 'Builder Reputation Score', url: 'https://360ghar.com/builder-reputation-score' },
          ]),
        ]}
      />
      <OffCanvas />
      ...
      <main className="body-bg">
        ...
        <section className="geo-hero">
          <div className="geo-hero__breadcrumb">
            <I18nLink to="/">Home</I18nLink> › <I18nLink to="/builder-reputation">Data Hub</I18nLink> › Builder Reputation Score
          </div>
        ...
        <section className="geo-section">
          <div className="geo-grid">
            {BUILDERS.map((b) => (
              <article
                key={b.name}
                className={`builder-card builder-card--${scoreToStatus(b.reraScore)}`}
                style={{ borderColor: STATUS_COLOR[scoreToStatus(b.reraScore)] }}
              >
                <div className="builder-card__header">
                  <h2 className="builder-card__name">{b.name}</h2>
                  <span
                    className="builder-card__score"
                    style={{ background: STATUS_COLOR[scoreToStatus(b.reraScore)] }}
                  >
                    {b.reraScore}
                  </span>
                </div>
